...
export default function Intro() {
  const words = ["Developer", "Coder", "Learner"];
  return (
    <>
      <div className="mt-16">
        <div className="flex items-center justify-center text-center flex-col ">
          ...
          <p className="text-sm max-w-xl mb-6 font-medium">
            ...
            <b> full-stack web developer</b> specializing in the MERN stack.
            With a background in Artificial Intelligence and Data Science, I
            thrive on building innovative, user-friendly web solutions.{" "}
            <br></br>
